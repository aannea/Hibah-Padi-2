...
# Class labels
class_labels = ['bacterial_leaf_blight','blast', 'brown spot', 'dead heart', 'hispa', 'normal']

# Load Data
print("Loading Data...")
train_loader, test_loader = load_data('dataset3/train_images', 'dataset3/test_images')
...
print("Classification report on 140*140 image inputs : ")
...
plt.title('Confusion Matrix on 140*140 image inputs')
plt.show()
...
torch.save(model_state, 'hybrid_cnn_elm_model.pth')
print("Hybrid model saved as 'hybrid_cnn_elm_model.pth'")
"""